                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="posisi" placeholder="Masukkan Posisi"
                                    required="required" autofocus="on" value="{{ $model->posisi }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="informasi_lowongan" required="required"
                                    placeholder="Masukkan Informasi Lowongan" value="{{ $model->informasi_lowongan }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="nama" required="required"
                                    placeholder="Masukkan Nama Lengkap" value="{{ $model->nama }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="umur" required="required"
                                    placeholder="Masukkan Umur" value="{{ $model->umur }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="tempat_lahir" required="required"
                                    placeholder="Masukkan Tempat Lahir" value="{{ $model->tempat_lahir }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="date" name="tanggal_lahir" required="required"
                                    placeholder="Masukkan Tanggal Lahir" value="{{ $model->tanggal_lahir }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">Status Perkawinan</div>
                            <div class="col-md-8">
                                <!-- <input class="form-control" type="text" name="alamat" required="required" placeholder="Masukkan Data" value=""> -->
                                <select class="option form-control" name="status_perkawinan" required="required">
                                    <option value="">--Pilih Status Perkawinan--</option>
                                    @foreach ($statusOptions as $option)
                                        <option value="{{ $option }}"
                                            {{ $model->status_perkawinan == $option ? 'selected' : '' }}>{{ $option }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="berat_badan" required="required"
                                    placeholder="Masukkan Berat Badan" value="{{ $model->berat_badan }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="tinggi_badan" required="required"
                                    placeholder="Masukkan Tinggi Badan" value="{{ $model->tinggi_badan }}">
                            </div>
                        </div>
                    </div>
                    <!-- #2 -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="alamat" required="required"
                                    placeholder="Masukkan Alamat" value="{{ $model->alamat }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="no_hp" required="required"
                                    placeholder="Masukkan No HP" value="{{ $model->no_hp }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="email" required="required"
                                    placeholder="Masukkan Email" value="{{ $model->email }}">
                            </div>
                        </div>
                    </div>
                    <!-- #3 -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" name="bahasa_pertama" required="required"
                                        placeholder="Masukkan Bahasa Pertama" value="{{ $model->bahasa_pertama }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
