                ...
                <div class="col-md-12 row d-none">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="basic_gaji" placeholder="Masukkan Nominal"
                                    value="" autofocus="on">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="uang_saku" placeholder="Masukkan Nominal"
                                    value="" autofocus="on">
                            </div>
                        </div>
                    </div>
