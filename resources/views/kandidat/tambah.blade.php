			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="text" name="nama" required="required" placeholder="Masukkan Nama Lengkap" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
						<div class="col-md-4">Umur</div>
						<div class="col-md-8">
							<input class="form-control" type="text" name="umur" required="required" placeholder="Masukkan Umur" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
				...
				<div class="col-md-6">
					...
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="text" name="alamat" required="required" placeholder="Masukkan Alamat" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
				...
				<div class="col-md-12 row">
					...
					<div class="col-md-6">
						<div class="row mb-3">
							...
							<div class="col-md-8">
								<input class="form-control" type="text" name="bahasa_pertama" required="required" placeholder="Masukkan Bahasa Pertama" value="" autofocus="on">
							</div>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-12 row">
						<div class="col-md-4">
							<div class="row mb-3">
								...
								<div class="col-md-12">
									<textarea name="skill_tambahan" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan Nama Sekolah"></textarea>
					...
					<div class="col-md-12 row">
						...
						<div class="col-md-3">
							<div class="row mb-3">
								...
								<div class="col-md-12">
									<input class="form-control" type="text" name="bahasa_lain" placeholder="Masukkan Alasan" value="" autofocus="on">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12 row d-none">
					...
					<div class="col-md-6">
						...
						<div class="row mb-3">
							...
							<div class="col-md-8">
								<textarea name="skill_tambahan" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan Skill"></textarea>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-md-4">Harapan Di Pekerjaan Baru</div>
							<div class="col-md-8">
								<textarea name="harapan" id="" cols="30" rows="5" class="form-control" placeholder="Masukkan Harapan"></textarea>
							</div>
						</div>
