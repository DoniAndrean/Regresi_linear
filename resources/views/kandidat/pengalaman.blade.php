                ...
                <div class="col-md-12 row">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea name="reason_for_leaving" id="" cols="100" rows="4"
                ...
                <div class="col-md-12 row">
                    <div class="col-md-4">
                        <div class="row mb-3">
                            <div class="col-md-12">Company Name</div>
                            <div class="col-md-12">
                                <input class="form-control" type="text" value="{{ $value->company_name }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="row mb-3">
                            <div class="col-md-12">Position</div>
                            <div class="col-md-12">
                                <input class="form-control" type="text" value="{{ $value->position }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="row mb-3">
                            <div class="col-md-12">Periode</div>
                            <div class="col-md-12">
                                <input class="form-control" type="text" value="{{ $value->periode }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
