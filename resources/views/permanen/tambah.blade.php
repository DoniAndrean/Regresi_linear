...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Data Karyawan Permanen</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
	...
	<section class="content">
		...
		<form action="/permanen/store" method="POST" enctype="multipart/form-data" style="background: #FFFFFF;border-radius:20px;" class="p-4">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="number" name="id_sap" required="required" placeholder="Masukkan SAP" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="textarea" name="nama_sekolahasal" required="required" placeholder="Masukkan Nama Sekolah/Universitas" value="" autofocus="on">
					...
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="number" name="tahun_lulus" required="required" placeholder="Masukkan Tahun Lulus" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
				...
				<div class="col-md-6">
					...
					<div class="row mb-3">
						...
						<div class="col-md-8">
							<input class="form-control" type="number" name="no_wa" required="required" placeholder="Masukkan Nomor WhatsApp" value="" autofocus="on">
						</div>
					</div>
					<div class="row mb-3">
